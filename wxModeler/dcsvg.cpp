...
//This function implementation is added by me --ms (not existent in the wx contrib library)
                                   ...
                                   wxPolygonFillMode fillStyle)
{
    ...
    {
        s = s + wxT("M ");
        sTmp.Printf ( wxT("%d %d"), points [p_id].x+xoffset, points[p_id].y+yoffset );
        CalcBoundingBox ( points [p_id].x+xoffset, points[p_id].y+yoffset);
        p_id++;
        s = s + sTmp;
