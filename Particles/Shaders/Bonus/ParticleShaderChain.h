/**
Declaration of ParticleShaderChain
@file ParticleShaderChain.h
@author Wen Su
This class find the possible singular curves by connection neighboring singularities
*/

#ifndef PARTICLESHADERCHAIN_H
#define PARTICLESHADERCHAIN_H
...
class ParticleShaderChain : public ParticleShader
{
	class Neighbor
	{
	public:
...
protected:
	double lineWidth,percentLength;
	bool autoUpdate;
