...
#ifndef PARTICLESHADERVORONOI_H
#define PARTICLESHADERVORONOI_H
...
class ParticleShaderVoronoi: public ParticleShader
{
...
protected:
	...
	CGprogram fProgramZero, fProgramOne,
		fProgramTwo;					// The fragment programs
...
public:
	...
	ParticleShaderVoronoi(Particles *ps=NULL);
	
	virtual void attachAttributes();
   
	virtual ~ParticleShaderVoronoi();
