...
#include "ParticleShaderVoronoi.h"
#include "AdaptiveRepulsionData.h"
#include "ParticleNormal.h"
#include "ParticlePosition.h"

REGISTER_PARTICLESTUFF(ParticleShaderVoronoi,"Shader:ParticleShaderVoronoi");
...
void ParticleShaderVoronoi::attachAttributes()
{
...
void ParticleShaderVoronoi::bindCGParametersVertex()
{
...
void ParticleShaderVoronoi::setupCG()
{
	...
	fProgramOne = cgCreateProgramFromFile(cgContext, CG_SOURCE, "../Particles/flat_frag.cg",
		fProfile, NULL, NULL);
...
void ParticleShaderVoronoi::drawShape(int i)
{
