#include "ParticleShaderText.h"
//#include "AdaptiveRepulsionData.h"

REGISTER_PARTICLESTUFF(ParticleShaderText,"Shader:ParticleShaderText");

ParticleShaderText::ParticleShaderText(Particles *ps)
	:ParticleShader(ps,std::string("ParticleShaderText"))
{
	new Attached<ParticleScalar>(this,&scalar);

	new PSParamBool(this,&useScalar,true,"uS","useScalar","Choose whether the text should display the particle ID# or some scalar value.");
	//quad=gluNewQuadric();
...
ParticleShaderText::~ParticleShaderText()
{
