//*****************************************************************************
//	CSGUnion.h: Header file for the CSGUnion class.
//	Author: Xinlai Ni
//	1/13/2006
//*****************************************************************************

#ifndef	XNTOOLS_IMPLICIT_CSGUNION_H
#define	XNTOOLS_IMPLICIT_CSGUNION_H

#include "Surface/Implicit/Implicit.h"
#include "Surface/Implicit/Operator/BinaryOp.h"

class CSGUnion : public BinaryOp
{
public:
...
#endif	//	XNTOOLS_IMPLICIT_CSGUNION_H
